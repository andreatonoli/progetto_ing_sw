...
public class FlipTest {
    ...
    public void FlipStarterCard(){
        ...
        a.setCurrentSide();
        assertEquals(Symbols.EMPTY, a.getCornerSymbol(CornerEnum.TL));
        assertEquals(Symbols.EMPTY, a.getCornerSymbol(CornerEnum.TR));
        assertEquals(Symbols.EMPTY, a.getCornerSymbol(CornerEnum.BR));
        assertEquals(Symbols.EMPTY, a.getCornerSymbol(CornerEnum.BL));
        assertNotNull(s.getSymbols());
