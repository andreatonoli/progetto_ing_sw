...
//        try {
//            player1.placeCard(r2, new int[]{0,0} , CornerEnum.TR);
//            player1.placeCard(r3, new int[]{0,0} , CornerEnum.BR);
//            player1.placeCard(g11, new int[]{1,-1} , CornerEnum.BR);
...
//        try {
//            player1.placeCard(p31, new int[]{0,0} , CornerEnum.TL);
//            player1.placeCard(p33, new int[]{-1,1} , CornerEnum.TL);
//            player1.placeCard(p32, new int[]{-2,2} , CornerEnum.TL);
//        } catch (OccupiedCornerException | NotInTurnException | AlreadyUsedPositionException |
//                 CostNotSatisfiedException ex) {
//            System.out.println(ex.getMessage());
//        }
...
//        try {
//            player2.placeCard(r6, new int[]{0,0} , CornerEnum.TR);
//            player2.placeCard(g15, new int[]{1,1} , CornerEnum.BR);
//            player2.placeCard(b26, new int[]{2,0} , CornerEnum.BR);
//        } catch (OccupiedCornerException | NotInTurnException | AlreadyUsedPositionException |
//                CostNotSatisfiedException ex) {
//            System.out.println(ex.getMessage());
//        }
...
//        try {
//            player2.placeCard(b21, new int[]{0,0} , CornerEnum.TL);
//        } catch (OccupiedCornerException | NotInTurnException | AlreadyUsedPositionException |
//                 CostNotSatisfiedException ex) {
//            System.out.println(ex.getMessage());
//        }
...
//        try {
//            player3.placeCard(g12, new int[]{0,0} , CornerEnum.TR);
//            player3.placeCard(g13, new int[]{0,0} , CornerEnum.BR);
//            player3.placeCard(p34, new int[]{1,-1} , CornerEnum.BL);
//        } catch (OccupiedCornerException | NotInTurnException | AlreadyUsedPositionException |
//                 CostNotSatisfiedException ex) {
//            System.out.println(ex.getMessage());
//        }
...
//        try {
//            player3.placeCard(g17, new int[]{0,0}, CornerEnum.TL);
//            player3.placeCard(b25, new int[]{-1,1}, CornerEnum.BL);
//            player3.placeCard(p35, new int[]{-2,0},CornerEnum.BR);
//        } catch (OccupiedCornerException | NotInTurnException | AlreadyUsedPositionException |
//                 CostNotSatisfiedException ex) {
//            System.out.println(ex.getMessage());
//        }
...
//        ResourceCard b21 = new ResourceCard(new Corner[]{new Corner(Symbols.ANIMAL), new Corner(Symbols.ANIMAL), new Corner(Symbols.NOCORNER), new Corner(Symbols.EMPTY) }, 21, 0);
//        try {
//            player1.placeCard(b21, new int[]{0,0} , CornerEnum.TL);
//        } catch (OccupiedCornerException | NotInTurnException | AlreadyUsedPositionException |
//                 CostNotSatisfiedException ex) {
//            System.out.println(ex.getMessage());
//        }
